...
class MensajesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mensaje" do
    assert_difference("Mensaje.count") do
      post mensajes_url, params: { mensaje: { contenido: @mensaje.contenido, conversacion_id: @mensaje.conversacion_id } }
    end
  ...
  test "should update mensaje" do
    patch mensaje_url(@mensaje), params: { mensaje: { contenido: @mensaje.contenido, conversacion_id: @mensaje.conversacion_id } }
